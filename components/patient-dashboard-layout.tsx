...
import { Patient_Sidebar } from "./sidebar_patient";

export function PatientDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col ">
      ...
      <div className="flex flex-1 items-start">
        ...
        <div ref={sidebarRef}>
          <Patient_Sidebar isOpen={isSidebarOpen} setIsOpen={setIsSidebarOpen} />
        </div>
