...
export function Clinic_Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    
    {
      ...
      icon: Calendar,
      submenu: [
        { title: "All Appointments", href: "/clinic-dashboard/appointments" },
        // { title: "Add Appointment", href: "/appointments/add" },
        { title: "Calendar View", href: "/clinic-dashboard/appointments/calendar" },
    ...
    // {
    //   title: "Reports",
    //   href: "/clinic-dashboard/reports",
    //   icon: BarChart3,
    //   submenu: [
    //     { title: "Overview", href: "/clinic-dashboard/reports" },
    //     { title: "Appointment Reports", href: "/clinic-dashboard/reports/appointments" },
    //     { title: "Financial Reports", href: "/clinic-dashboard/reports/financial" },
    //     // { title: "Inventory Reports", href: "/reports/inventory" },
    //     { title: "Patient Visit Reports", href: "/clinic-dashboard/reports/patients" },
    //   ],
    // },
